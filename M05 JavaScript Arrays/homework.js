...
function multiplicarArgumentos() {
   ...
   // Si noe pasan argumentos retorna 0. Si se pasa un argumento, simplemente retórnalo.
...
function cuentoElementos(array) {
   ...
   // Tu código:
   var resultado = array.filter(i => i > 18).length
    return resultado
}

function diaDeLaSemana(numeroDeDia) {
   // Supongamos que los días de la semana se codifican como 1 = Domingo, 2 = Lunes y así sucesivamente.
   // Realiza una función que, el número del día de la semana, retorne: "Es fin de semana"
